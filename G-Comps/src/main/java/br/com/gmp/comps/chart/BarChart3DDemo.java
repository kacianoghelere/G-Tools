 ...
 */
package br.com.gmp.comps.chart;
 ...
 *
 */
public class BarChart3DDemo extends ApplicationFrame {
     ...
     */
    public BarChart3DDemo(final String title) {
    ...
    public static void main(final String[] args) {
        ...
        final BarChart3DDemo demo = new BarChart3DDemo("3D Bar Chart Demo 3");
        demo.pack();
